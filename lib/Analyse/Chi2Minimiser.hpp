...
#include "../libCo.hpp"
#include "../Classes/FlexibleHisto.hpp"
...
namespace Colib
{
  ...
  public:
    ...
    {
      auto chi2 = chi2Calc.calculate(histo_flex);
      if (chi2 < m_min_chi2) 
      {
        m_min_chi2 = chi2;
        m_histo_flex = histo_flex;
...
// {
  ...
  //     auto calib = *m_histo_flex; // Dereference aliasing for elegance and effiency
  ...
  // private:
  //   CalibAndScale * m_histo_flex = nullptr;
  //   TH1* m_reference = nullptr;
  // };
  // }