...
/**
 * @brief This is a homemade .data reader
 * 
...
protected:
  ...
  //Manages the columns :
  DataLine m_labels_column; // List of the index of the columns
...
#ifdef unordered_DataFile
  std::unordered_map<Index, DataPoints> m_data;
#else 
  std::map<Index, DataPoints> m_data;
#endif //unordered_DataFile

  // Vectorized data : unused so far
