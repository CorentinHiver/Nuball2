...
constexpr inline Time_t   seconds = 1.e+12; // unit base is ps
...
constexpr inline Time_t operator""_s (long double time) noexcept {return static_cast<Time_t>(time*seconds*1e+00);}
constexpr inline Time_t operator""_ms(long double time) noexcept {return static_cast<Time_t>(time*seconds*1e-03);}
constexpr inline Time_t operator""_us(long double time) noexcept {return static_cast<Time_t>(time*seconds*1e-06);}
constexpr inline Time_t operator""_ns(long double time) noexcept {return static_cast<Time_t>(time*seconds*1e-09);}
constexpr inline Time_t operator""_ps(long double time) noexcept {return static_cast<Time_t>(time*seconds*1e-12);}
constexpr inline Time_t operator""_fs(long double time) noexcept {return static_cast<Time_t>(time*seconds*1e-15);}

constexpr inline Time_t operator""_s (unsigned long long time) noexcept {return static_cast<Time_t>(time*seconds*1e-00l);}
constexpr inline Time_t operator""_ms(unsigned long long time) noexcept {return static_cast<Time_t>(time*seconds*1e-03l);}
constexpr inline Time_t operator""_us(unsigned long long time) noexcept {return static_cast<Time_t>(time*seconds*1e-06l);}
constexpr inline Time_t operator""_ns(unsigned long long time) noexcept {return static_cast<Time_t>(time*seconds*1e-09l);}
constexpr inline Time_t operator""_ps(unsigned long long time) noexcept {return static_cast<Time_t>(time*seconds*1e-12l);}
constexpr inline Time_t operator""_fs(unsigned long long time) noexcept {return static_cast<Time_t>(time*seconds*1e-15l);}
