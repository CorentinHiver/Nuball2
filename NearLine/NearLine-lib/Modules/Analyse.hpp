...
private:
  ...
  MTTHist<TH2F> m_ToF_801;
  MTTHist<TH2F> m_ToF_801_bis;
  // MTTHist<TH1F> DeltaT       ;
  ...
  MTTHist<TH1F> m_R3_Spectra_Doppler_correct;
      // - Subrings
  MTTHist<TH1F> m_subR1_Spectra;
  MTTHist<TH1F> m_subR2_Spectra;
  MTTHist<TH1F> m_subR3_Spectra;
  MTTHist<TH1F> m_subR4_Spectra;
      // - Each crystal of each ring :
  MTTHist<TH1F> m_R2_crystal0_Spectra;
  MTTHist<TH1F> m_R2_crystal1_Spectra;
  MTTHist<TH1F> m_R2_crystal2_Spectra;
  MTTHist<TH1F> m_R2_crystal3_Spectra;
  MTTHist<TH1F> m_R3_crystal0_Spectra;
  MTTHist<TH1F> m_R3_crystal1_Spectra;
  MTTHist<TH1F> m_R3_crystal2_Spectra;
  MTTHist<TH1F> m_R3_crystal3_Spectra;
  ...
  MTTHist<TH2F> m_DSSD_Clover_E_VS_pulse;
  ...
  MTTHist<TH1F> m_DSSD_gate_Clover_R2;
  MTTHist<TH1F> m_DSSD_gate_Clover_R3;
  MTTHist<TH2F> m_DSSD_gate_Clover_bidim;
  MTTHist<TH2F> m_DSSD_Clover_E_VS_ToF_first_DSSD;
  MTTHist<TH2F> m_DSSD_Clover_E_VS_Pulse;
  MTTHist<TH2F> m_prompt_particule_trig_Clover_spectra;
  MTTHist<TH2F> m_prompt_particule_gated_Clover_delayed_VS_delayed;
  MTTHist<TH2F> m_clover_VS_DSSD;
  std::vector<MTTHist<TH2F>> m_DSSD_R_VS_Clover;
  ...
  MTTHist<TH2F> m_DSSD_1R2S_Sector1_VS_Sector2;
  MTTHist<TH2F> m_DSSD_1R2S_R_VS_Sector1;
  MTTHist<TH2F> m_DSSD_1R2S_R_VS_Sector2;
  MTTHist<TH2F> m_DSSD_1R2S_R_VS_sum_Sectors;
  MTTHist<TH2F> m_DSSD_1R2S_Sectors_labels;
  MTTHist<TH1F> m_DSSD_1R2S_Rings_labels;

  MTTHist<TH2F> m_DSSD_2R1S_R1_VS_R2;
  MTTHist<TH2F> m_DSSD_2R1S_R1_VS_Sector;
  MTTHist<TH2F> m_DSSD_2R1S_R2_VS_Sector;
  MTTHist<TH2F> m_DSSD_2R1S_sum_R_VS_Sector;
  MTTHist<TH2F> m_DSSD_2R1S_Rings_labels;
  MTTHist<TH1F> m_DSSD_2R1S_Sectors_labels;
  ...
  MTTHist<TH2F> m_DSSD_Energy_VS_Pulse;
  std::vector<MTTHist<TH2F>> m_DSSD_E_VS_ToF_each_channel;
  ...
  MTTHist<TH2F> timeshift_VS_ToF_Paris_back;
  MTTHist<TH2F> timeshift_VS_ToF_Paris_front;
  MTTHist<TH2F> timeshift_VS_ToF_DSSD;
  MTTHist<TH1F> m_DSSD_1R1S_time_gap;
  MTTHist<TH2F> m_DSSD_E_VS_timeshift;
  MTTHist<TH2F> m_DSSD_E_VS_time_first_Paris;
  MTTHist<TH2F> m_ReF_E_VS_timeshift_DSSD;
  MTTHist<TH2F> m_Paris_Back_E_VS_timeshift;
  MTTHist<TH2F> m_Paris_Front_E_VS_timeshift;
  // std::unique_ptr<TH1D> evolution_RF;
  MTTHist<TH2F> m_E_VS_time_of_Ref_vs_RF;
  MTTHist<TH2F> m_E_VS_timeshift_FATIMA;
    //Neutrons
  ...
  MTTHist<TH2I> m_mult_clean_Clover_VS_mult_raw_Ge;
  MTTHist<TH2I> m_mult_in_a_Clover_VS_mult_raw_Ge;
