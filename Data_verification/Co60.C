...
void Co60()
{
  ...
  MultiHist<TH2F> gated_ratio_Phoswitch_VS_label ("gated_ratio_Phoswitch_VS_label", "gated_ratio_Phoswitch_VS_label;[keV]", 1000, 0, 1000, 1000,-2,2);
        ...
        if (gate(gate_low, nrj_i, gate_high))
        {
          ...
          for (auto const & phos : paris.phoswitches) 
          {
            ...
            else 
            {
              ...
              gated_ratio_Phoswitch_VS_label.Fill(phos->label, phos->qshort/phos->qlong);
  ...
  outfile->cd();
    ...
    gated_ratio_Phoswitch_VS_label.Write();
